 ...
 */
final class Version20250219203840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98CDDDF1A2 FOREIGN KEY (ville_depart) REFERENCES ville (id)');
        $this->addSql('ALTER TABLE trajet ADD CONSTRAINT FK_2B5BA98C25165746 FOREIGN KEY (ville_arrive) REFERENCES ville (id)');
